    ...
    ui(new Ui::Widget)
{
    ...
    this->server = new QTcpServer(this);
        ...
        ///开启监听
        this->server->listen(QHostAddress::Any,8765);
    ...
    this->fileserver = new QTcpServer(this);
        ...
        this->fileserver->listen(QHostAddress::Any,8766);
...
void Widget::acceptFileConnection()
{
    bytesWritten = 0;
    ///每次发送数据大小为64kb
    perDataSize = 64*1024;
...
void Widget::receiveData()
{
    ...
    ////接收数据
    QString str = QString::fromLocal8Bit( this->socket->readAll());
    this->filename = str;
